...
def format_file_size(num: float, suffix: str = 'Byte'):
    for unit in (
        '',
        'Kilo',
        'Mega',
...
def computer_storage_linux_style(num: float, suffix: str = 'B'):
...
def computer_storage_windows_style(num: float, suffix: str = 'B'):
