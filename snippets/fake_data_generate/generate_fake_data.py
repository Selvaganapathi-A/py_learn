...
class CustomProvider(BaseProvider):
    ...
    def personalia(self):
        ...
        __person_name = self.generator.name_male() if __person_gender == 'M' else self.generator.name_female()
        __person_age = self.random_element(self.__person_ages)
        __person_email_address = (
            f'{__person_name.lower().replace(" ", "_")}_{2024 - __person_age}@{self.generator.domain_name()}'
        )
        return Person(
            __person_name,
            __person_gender,
